...
const NAV = [
  ...
  { href: "/av-income",   icon: "💹", key: "nav_av_income" as const },
  { href: "/investments", icon: "📊", key: "nav_investments" as const },
  ...
  { href: "/admin/analytics",  icon: "📊", key: "nav_analytics" as const },
          ...
          <>
            ...
            {canSeeConductNotes && (
              <NavItem
                href="/staff-conduct"
                icon="🎽"
                label={t("nav_conduct_notes")}
                collapsed={collapsed}
                active={pathname.startsWith("/staff-conduct")}
              />
            )}

            {!canAccess("walkins") && canSeeWalkins && (
              <NavItem
                href="/walkins"
                icon="🚶"
                label={t("nav_walkins")}
