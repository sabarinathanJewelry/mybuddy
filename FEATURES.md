...
- Product mapper: ERP product name → incentive code; **inline add from unmapped badge** — click "unmapped" next to any product in the data table, type the incentive code, press Enter to add it to the mapper instantly without leaving the page
