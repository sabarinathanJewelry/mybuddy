...
- **Recovery-adjusted incentive**: when a write-off exists, incentive scales to the recovered fraction — e.g. received ₹25,000 of ₹27,000 = 92.6% recovery → incentive × 0.926; Inc column shows reduced amount + strikethrough of full amount + recovery % badge; flows into By Staff totals
