-- 159: Respect shop_exceptions in punctuality scoring.
-- On days when the shop opens late, the on-time cutoff shifts accordingly:
--   cutoff = shop_opens_at + 20 min grace  (instead of default 9:30 + 20 = 9:50)
...
BEGIN
  ...
  -- On-time: first punch <= cutoff for that day.
  -- Exception days use shop_opens_at + grace; normal days use shift_start + grace.
  punctuality AS (
